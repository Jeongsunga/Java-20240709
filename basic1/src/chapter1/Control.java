...
public class Control {
	...
	public static void main(String[] args) {
		...
		// if 문 : 주어진 조건이 true이면 코드를 실행하게 하는 것
		...
		// else 문 : if 문의 조건-논리표현식이 false이면 코드를 실행하게 하는 것
		// if(조건-논리표현식) {true이면 실행할 코드 블럭}
		// else {조건-논리표현식이 false이면 실행할 코드 블럭}
		
		// 주의!
		// 1. else 문은 반드시 if문 이후에 와야함(else문 단독 사용 불가)
