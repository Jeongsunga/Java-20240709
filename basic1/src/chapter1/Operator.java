...
public class Operator {
	...
	public static void main(String[] args) {
		...
		final int NUMBER = 5; // 상수는 증감 연산자 사용 X
		
		// 대입 연산자 : 좌항에 우항을 할당
		// 일반 대입 연산자(=) : 좌항에 우항의 연산 결과를 할당
		number = 10 + 5;
		// 복합 대입 연산자(타연산자=) : 좌항에 좌항과 우항을 연산한 결과를 할당
		// 좌항은 반드시 초기화가 되어있어야 한다.
		// 좌항은 반드시 일반 변수(상수 불가능)
		number += 3;
		System.out.println(number);
		...
		// 논리 연산자 : 피연산자가 모두 논리 형태, 피연산자를 조합
		...
		// 논리 OR 연산자 : || - 좌항과 우항 중 하나라도 true라면 true, 모두 false라면 false
