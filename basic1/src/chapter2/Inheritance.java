...
class SalesMan extends Human{
	...
	SalesMan(String name, int age, int sales){
		super(name, age);
		this.sales = sales;
		// 부모 생성자 호출은 반드시 현재 생성자의 첫 번째 구문으로 작성해야 함!
	...
	// @Override : 컴파일에게 현재 작업이 오버라이딩 작업임을 알려줌
	@Override
	void sayHello() {
...
public class Inheritance {
	...
	public static void main(String[] args) {
		...
		Developer developer1 = new Developer("홍길동", 20, new String[] {"java"});
		...
		// 모든 클래스는 'Object'라는 클래스를 최상위 클래스로 반드시 상속받고 있음
		// Object 클래스에 존재하는 메서드
	}
