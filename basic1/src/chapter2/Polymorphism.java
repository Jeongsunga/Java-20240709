...
//		System.out.println(footballPlay.age);
		...
		System.out.println(footballPlayer4.team); // 오류
		footballPlayer4.kick(); // 오류
		footballPlayer4.foul(); // 오류
	...
	void method(Object object) {
		// object;
		// 매개변수나 반환타입으로 Object 타입으로 지정하게 되면
		// 해당 인스턴스 사용시 문제(강제 다운캐스팅 시 타입 불일치)가 발생할 수 있음(사용 지양!)
	}
}
