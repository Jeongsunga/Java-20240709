...
public class AccessModifierSub {
	...
	void method() {
		...
		// 접근 제어자가 public이기 때문에 외부 패키지에서 접근 가능
...
//		instance.privateVariable = 0;
		...
		// AccessModifier의 publicVariable, protectedVariable의 필드는
		// 접근 제어자가 각각 public, protected 이기 때문에 자손 클래스에서 접근이 가능
		super.publicVariable = 0;
		super.protectedVariable = 0;
		
		// AccessModifier의 defaultVariable, privateVariable의 필드는
		// 접근 제어자가 각각 default, private 이기 때문에 자손 클래스에서 접근이 불가능
